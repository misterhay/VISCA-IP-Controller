...
def memory_set_function(memory_number):
    ...
    label0.set(entry0.get())
    label1.set(entry1.get())
    label2.set(entry2.get())
    label3.set(entry3.get())
    label4.set(entry4.get())
    label5.set(entry5.get())
    label6.set(entry6.get())
    label7.set(entry7.get())
    label8.set(entry8.get())
    label9.set(entry9.get())
    labelA.set(entryA.get())
    labelB.set(entryB.get())
    labelC.set(entryC.get())
    labelD.set(entryD.get())
    labelE.set(entryE.get())
    labelF.set(entryF.get())
...
# Recall buttons and labels
Label(root, text='Recall', bg='white').grid(row=1, column=0, columnspan=2)
...
label0 = StringVar()
Label(root, textvariable=label0, bg='white').grid(sticky=W, row=2, column=1)
label1 = StringVar()
Label(root, textvariable=label1).grid(sticky=W, row=3, column=1)
label2 = StringVar()
Label(root, textvariable=label2).grid(sticky=W, row=4, column=1)
label3 = StringVar()
Label(root, textvariable=label3).grid(sticky=W, row=5, column=1)
label4 = StringVar()
Label(root, textvariable=label4).grid(sticky=W, row=6, column=1)
label5 = StringVar()
Label(root, textvariable=label5).grid(sticky=W, row=7, column=1)
label6 = StringVar()
Label(root, textvariable=label6).grid(sticky=W, row=8, column=1)
label7 = StringVar()
Label(root, textvariable=label7).grid(sticky=W, row=9, column=1)
label8 = StringVar()
Label(root, textvariable=label8).grid(sticky=W, row=10, column=1)
label9 = StringVar()
Label(root, textvariable=label9).grid(sticky=W, row=11, column=1)
labelA = StringVar()
Label(root, textvariable=labelA).grid(sticky=W, row=12, column=1)
labelB = StringVar()
Label(root, textvariable=labelB).grid(sticky=W, row=13, column=1)
labelC = StringVar()
Label(root, textvariable=labelC).grid(sticky=W, row=14, column=1)
labelD = StringVar()
Label(root, textvariable=labelD).grid(sticky=W, row=15, column=1)
labelE = StringVar()
Label(root, textvariable=labelE).grid(sticky=W, row=16, column=1)
labelF = StringVar()
Label(root, textvariable=labelF).grid(sticky=W, row=17, column=1)

# Store buttons and entry boxes
Label(root, text='Store', bg='red').grid(row=1, column=7, columnspan=2)
Button(root, text=0, bg='red', command=lambda: memory_set_function(0)).grid(row=2, column=8)
Button(root, text=1, bg='red', command=lambda: memory_set_function(1)).grid(row=3, column=8)
Button(root, text=2, bg='red', command=lambda: memory_set_function(2)).grid(row=4, column=8)
Button(root, text=3, bg='red', command=lambda: memory_set_function(3)).grid(row=5, column=8)
Button(root, text=4, bg='red', command=lambda: memory_set_function(4)).grid(row=6, column=8)
Button(root, text=5, bg='red', command=lambda: memory_set_function(5)).grid(row=7, column=8)
Button(root, text=6, bg='red', command=lambda: memory_set_function(6)).grid(row=8, column=8)
Button(root, text=7, bg='red', command=lambda: memory_set_function(7)).grid(row=9, column=8)
Button(root, text=8, bg='red', command=lambda: memory_set_function(8)).grid(row=10, column=8)
Button(root, text=9, bg='red', command=lambda: memory_set_function(9)).grid(row=11, column=8)
Button(root, text='A', bg='red', command=lambda: memory_set_function(10)).grid(row=12, column=8)
Button(root, text='B', bg='red', command=lambda: memory_set_function(11)).grid(row=13, column=8)
Button(root, text='C', bg='red', command=lambda: memory_set_function(12)).grid(row=14, column=8)
Button(root, text='D', bg='red', command=lambda: memory_set_function(13)).grid(row=15, column=8)
Button(root, text='E', bg='red', command=lambda: memory_set_function(14)).grid(row=16, column=8)
Button(root, text='F', bg='red', command=lambda: memory_set_function(15)).grid(row=17, column=8)
entry0 = Entry(root, textvariable=StringVar(), justify='right')
entry0.grid(row=2, column=7)
entry1 = Entry(root, textvariable=StringVar(), justify='right')
entry1.grid(row=3, column=7)
entry2 = Entry(root, textvariable=StringVar(), justify='right')
entry2.grid(row=4, column=7)
entry3 = Entry(root, textvariable=StringVar(), justify='right')
entry3.grid(row=5, column=7)
entry4 = Entry(root, textvariable=StringVar(), justify='right')
entry4.grid(row=6, column=7)
entry5 = Entry(root, textvariable=StringVar(), justify='right')
entry5.grid(row=7, column=7)
entry6 = Entry(root, textvariable=StringVar(), justify='right')
entry6.grid(row=8, column=7)
entry7 = Entry(root, textvariable=StringVar(), justify='right')
entry7.grid(row=9, column=7)
entry8 = Entry(root, textvariable=StringVar(), justify='right')
entry8.grid(row=10, column=7)
entry9 = Entry(root, textvariable=StringVar(), justify='right')
entry9.grid(row=11, column=7)
entryA = Entry(root, textvariable=StringVar(), justify='right')
entryA.grid(row=12, column=7)
entryB = Entry(root, textvariable=StringVar(), justify='right')
entryB.grid(row=13, column=7)
entryC = Entry(root, textvariable=StringVar(), justify='right')
entryC.grid(row=14, column=7)
entryD = Entry(root, textvariable=StringVar(), justify='right')
entryD.grid(row=15, column=7)
entryE = Entry(root, textvariable=StringVar(), justify='right')
entryE.grid(row=16, column=7)
entryF = Entry(root, textvariable=StringVar(), justify='right')
entryF.grid(row=17, column=7)
